...
// Test script for Branch Admin Approve Payment API
async function testBranchAdminApprovePaymentAPI() {
  console.log('🚀 Testing Branch Admin Approve Payment API\n');
  ...
  try {
    ...
    const approveOptions = {
      hostname: 'localhost',
      port: 3000,
      path: '/api/branch-admin/pending-fees/approve',
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`,
...
// Run the test
testBranchAdminApprovePaymentAPI();
